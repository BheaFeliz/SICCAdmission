          ...
          <div className="style=min-height: 140px;">
            ...
            <div className="m-5 grid gap-5 mb-6 md:grid-cols-4">
              ...
              <div className="grid grid-cols-3 gap-1">
                <SelectInput options={Monthoption} name="monthoption" {...formState} />
            ...
            <div className="m-5 grid gap-5 mb-6 md:grid-cols-4">
              <SelectInput options={Civilstatus} name="civilstatus" {...formState} />
              <TextInput label="Mobile Number" name="contactnumber" {...formState} />
            ...
            <div className="m-5 grid gap-5 mb-6 md:grid-cols-2">
              <SelectInput options={IndigentP} name="indigentP" onChange={handleIndigentChange} {...formState} />
              {showTextInput && (
                <TextInput label="If yes, specify the Indigenous group you belong to." type="text" name="indigentPy" className="form-input" {...formState} />
              )}
            </div>
            <div className="p-4">
            ...
            <div className="m-5 grid gap-5 mb-6 md:grid-cols-3">
              ...
              <TextInput label="City/Municipality" name="cityM" {...formState} />
            ...
            <div className="m-5 grid gap-5 mb-6 md:grid-cols-3">
              <SelectInput options={famBackground} name="familyB" onChange={handleFamilyBackgroundChange} {...formState} />
              {showFamilyBackgroundInput && (
                <TextInput label="Specify since when? (Year Only)" type="text" name="sincewhen" className="form-input" {...formState} />
              )}
              <TextInput label="Number of siblings in the family" name="Nsibling" {...formState} />
              <TextInput label="Who will support your study?" name="supstudy" {...formState} />
            </div>
            <div className="m-5 grid gap-5 mb-6 md:grid-cols-2">
              <SelectInput options={Ofw} onChange={handleOFWChange} name="ofw" {...formState} />
              {showOFWInput && (
                <TextInput label="Specify the job/profession of a family member abroad." type="text" name="ofwprofession" className="form-input" {...formState} />
              )}
              <SelectInput options={Scategory} label='Student Category' name='StudentCat' onChange={handleStudentCategoryChange} {...formState} />
              {showWorkingStudentInput && (
                <TextInput label='Nature of work' type='text' name='Nwork' className='form-input' />
              )}
            </div>
            <div className='m-5 grid gap-5 mb-6 md:grid-cols-1'>
              <SelectInput options={Studenttype} name='studenttype' onChange={handleStudentTypeChange} {...formState} />
            </div>
            {showFreshmenInput && (
              <div name='Freshmen'>
                <p>Freshmen:</p>
                <div className='m-5 grid gap-5 mb-6 md:grid-cols-4'>
                  <TextInput label='Last School Attended' type='text' name='F_nameSchool' className='form-input' {...formState} />
                  <TextInput label='Academic track' type='text' name='F_Atrack' className='form-input' {...formState} />
                  <TextInput label='Address City/Municipality/Province' type='text' name='F_AMprovince' className='form-input' {...formState} />
                  <TextInput label='Year Graduate' type='text' name='F_Ygrad' className='form-input' {...formState} />
                </div>
              </div>
            )}
            {showTransfereeInput && (
              <div>
                <p>Transferee:</p>
                <div className='m-5 grid gap-5 mb-6 md:grid-cols-4'>
                  <TextInput label='Last School Attended' type='text' name='T_nameSchool' className='form-input' {...formState} />
                  <TextInput label='Course' type='text' name='T_Atrack' className='form-input' {...formState} />
                  <TextInput label='Address City/Municipality/Province' type='text' name='T_AMprovince' className='form-input' {...formState} />
                  <TextInput label='Year Attended' type='text' name='T_Ygrad' className='form-input' {...formState} />
                </div>
              </div>
            )}
            <div className='m-5 grid gap-5 mb-6 md:grid-cols-1'>
