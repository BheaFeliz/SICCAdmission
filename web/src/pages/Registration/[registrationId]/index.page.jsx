    ...
    <Template>
      ...
      {isLoading || !registration ? (
        ...
        <section className='p-8 flex flex-col space-x-4 space-y-6'>
          ...
          <RowItem label='Birthdate' value={`${registration.monthoption} ${registration.date}, ${registration.year}`} />
          ...
          {registration.F_nameSchool && (
            <div>
              <p>Freshmen:</p>
              <RowItem label='Last School Attended' value={registration.F_nameSchool} />
          ...
          {registration.T_nameSchool && (
            <div>
              <p>Transferee:</p>
              <RowItem label='Last School Attended' value={registration.T_nameSchool} />
