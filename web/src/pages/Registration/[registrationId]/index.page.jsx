...
{registration.indigentPy && <RowItem label='Indigenous Group' value={registration.indigentPy} />}
...
{registration.sincewhen && <RowItem label='Since When' value={registration.sincewhen} />}
...
{registration.ofwprofession && <RowItem label='OFW Profession' value={registration.ofwprofession} />}
<RowItem label='Student Category' value={registration.StudentCat} />
{registration.Nwork && <RowItem label='Nature of Work' value={registration.Nwork} />}
<RowItem label='Student Type' value={registration.studenttype} />

<RowItem label='FRESHMEN' />
    <RowItem label='Last School Attended' value={registration.F_nameSchool || 'N/A'} />
    <RowItem label='Academic Track' value={registration.F_Atrack || 'N/A'} />
    <RowItem label='Address' value={registration.F_AMprovince || 'N/A'} />
    <RowItem label='Year Graduated' value={registration.F_Ygrad || 'N/A'} />
    <RowItem label='TRANSFEREE' />


    <RowItem label='Last School Attended' value={registration.T_nameSchool || 'N/A'} />
    <RowItem label='Course' value={registration.T_Atrack || 'N/A'} />
    <RowItem label='Address' value={registration.T_AMprovince || 'N/A'} />
    <RowItem label='Year Attended' value={registration.T_Ygrad || 'N/A'} />
